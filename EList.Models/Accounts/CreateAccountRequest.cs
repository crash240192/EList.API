namespace EList.Models.Accounts
{
    ...
    public class CreateAccountRequest
    {
        ...
        /// <summary>
        /// Устарело: Политика обработки ПДн — информационный документ, галочка не требуется.
        /// Поле сохранено для обратной совместимости клиентов и игнорируется сервером.
        /// </summary>
