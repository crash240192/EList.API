...
CREATE INDEX IF NOT EXISTS message_votes_message_id_idx ON public.message_votes (message_id);
CREATE INDEX IF NOT EXISTS message_votes_account_id_idx ON public.message_votes (account_id);
