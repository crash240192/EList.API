...
> Актуально: сентябрь 2026 (доп. правка 14.09.2026)  
> Backend: `develop` (чеклист, уведомления, antiflood, tickets stub)  
> Назначение: передача фронтенду изменений флоу и задач на UI  
>
> **Описание сервиса:** [SERVICE.md](./SERVICE.md) · **чеклист:** [production-readiness-checklist.md](./production-readiness-checklist.md) · **юр. билеты:** [legal-ticketing-review.md](./legal-ticketing-review.md).  
> Документация ведётся **вручную**, не обновляется автоматически при каждом коммите.  
> **Policy** — без обязательной галочки. **Кошелёк** — только баланс тарифа платформы, не оплата билетов.
...
- Кошельки/тарифы платформы — **другой** денежный контур (рудимент: только списание оплаты тарифа сервиса; не P2P и не оплата билетов).
