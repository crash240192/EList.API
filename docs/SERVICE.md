...
| Учёт списаний по тарифу | Не P2P и не переводы между пользователями |
| CRUD тарифов / валидаторов | Не escrow / не холд билетных денег |
| Пополнение через платёжный stub/ЮKassa (`wallet_deposits`) | Не замена сплита пользователь→продавец |
...
В UI и аналитике не смешивать: пополнение кошелька ≠ покупка билета. История кошелька — только депозиты и списания тарифа.
